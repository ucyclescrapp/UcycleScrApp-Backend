...
)
{
    ...
    // create the product
    if($product->PlaceBarterOrderSchedule()){
 
        // set response code - 201 created
        http_response_code(201);
 
        // tell the user
        echo json_encode(array("message" => "Thank you. Your barter request is currently being processed. We will contact you shortly."));
    }
    ...
    // if unable to create the product, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to send barter."));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to send barter. Data is incomplete."));
}
?>